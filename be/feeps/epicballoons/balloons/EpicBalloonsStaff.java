...
public class EpicBalloonsStaff {
    public static Map<Player, EpicBalloonsStaff> epicBalloonsMapStaff = new HashMap<>();
    private Player player;
    private ItemStack item;
    private Slime slime;
    private ArmorStand armorStand;

    public EpicBalloonsStaff(Player player, ItemStack item){
        this.player = player;
        this.item = item;
        if(epicBalloonsMapStaff.containsKey(this.player))
            epicBalloonsMapStaff.get(this.player).remove();

        epicBalloonsMapStaff.put(player, this);
    }
    ...
    public void remove(){
        ...
        epicBalloonsMapStaff.remove(this.player, this);
