...
import be.feeps.epicballoons.events.EpicEvents2;
import be.feeps.epicballoons.events.EpicEventsStaff;
...
public class Main extends JavaPlugin{
    ...
    public void onEnable() {
        ...
        Bukkit.getPluginManager().registerEvents(new EpicEvents2(), this);
        Bukkit.getPluginManager().registerEvents(new EpicEventsStaff(), this);
    }

    @Override
    public void onDisable() {
        EpicBalloons.epicBalloonsMap.values().forEach(EpicBalloons::remove);
        EpicBalloonsStaff.epicBalloonsMapStaff.values().forEach(EpicBalloonsStaff::remove);
    }
